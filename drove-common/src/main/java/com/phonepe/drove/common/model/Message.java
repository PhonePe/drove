...
@JsonSubTypes({
        ...
        @JsonSubTypes.Type(name = "START_LOCAL_SERVICE_INSTANCE", value = StartLocalServiceInstanceMessage.class),
        @JsonSubTypes.Type(name = "STOP_LOCAL_SERVICE_INSTANCE", value = StopLocalServiceInstanceMessage.class),
        @JsonSubTypes.Type(name = "BLACKLIST_REQUESTED", value = BlacklistExecutorMessage.class),
        @JsonSubTypes.Type(name = "BLACKLIST", value = BlacklistExecutorFinalizeMessage.class),
        ...
        @JsonSubTypes.Type(name = "LOCAL_SERVICE_INSTANCE_STATE_REPORT", value =
                LocalServiceInstanceStateReportMessage.class),
