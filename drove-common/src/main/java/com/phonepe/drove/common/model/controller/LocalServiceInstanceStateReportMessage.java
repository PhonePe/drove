...
public class LocalServiceInstanceStateReportMessage extends ControllerMessage {
    ExecutorResourceSnapshot resourceSnapshot;
    LocalServiceInstanceInfo instanceInfo;

    public LocalServiceInstanceStateReportMessage(
            MessageHeader header,
            ExecutorResourceSnapshot resourceSnapshot,
            LocalServiceInstanceInfo instanceInfo) {
        super(ControllerMessageType.LOCAL_SERVICE_INSTANCE_STATE_REPORT, header);
