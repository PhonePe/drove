 ...
 */
@Slf4j
public class ConfigTestingLocalServiceAction extends UpdatingLocalServiceAction {

    @Inject
    public ConfigTestingLocalServiceAction(LocalServiceStateDB stateDB) {
        super(stateDB);
    }
    ...
    protected LocalServiceInfo update(
        ...
        return existing.withActivationState(ActivationState.CONFIG_TESTING);
    }
}
