...
class ZkApplicationInstanceInfoDBTest extends ControllerTestBase {
    ...
    @Test
    @SneakyThrows
    void testSaveRetrieve(final CuratorFramework curator) {
    ...
    @Test
    @SneakyThrows
    void testCountActive(final CuratorFramework curator) {
        val db = new ZkApplicationInstanceInfoDB(curator, MAPPER);
        val spec = ControllerTestUtils.appSpec();
        val appId = ControllerUtils.deployableObjectId(spec);
        val instances = IntStream.rangeClosed(1, 100)
    ...
    @Test
    @SneakyThrows
    void testDeleteAll(final CuratorFramework curator) {
        val db = new ZkApplicationInstanceInfoDB(curator, MAPPER);
        val spec = ControllerTestUtils.appSpec();
        val appId = ControllerUtils.deployableObjectId(spec);
        val instances = IntStream.rangeClosed(1, 100)
    ...
    @Test
    @SneakyThrows
    void testStaleUpdate(final CuratorFramework curator) {
        val db = new ZkApplicationInstanceInfoDB(curator, MAPPER);
        val spec = ControllerTestUtils.appSpec();
        val appId = ControllerUtils.deployableObjectId(spec);
        val instances = IntStream.rangeClosed(1, 100)
    ...
    @Test
    @SneakyThrows
    void testOldInstances(final CuratorFramework curator) {
        val db = new ZkApplicationInstanceInfoDB(curator, MAPPER);
        val spec = ControllerTestUtils.appSpec();
        val appId = ControllerUtils.deployableObjectId(spec);
        val instances = IntStream.rangeClosed(1, 100)
