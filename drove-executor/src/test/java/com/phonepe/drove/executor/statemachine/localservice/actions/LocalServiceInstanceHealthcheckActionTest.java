...
import static com.phonepe.drove.executor.ExecutorTestingUtils.testLocalServiceInstanceSpec;
 ...
 */
@WireMockTest
class LocalServiceInstanceHealthcheckActionTest extends AbstractTestBase {
    ...
    void testUsualFlow(final WireMockRuntimeInfo wm) {
        ...
        val action = new LocalServiceInstanceHealthcheckAction();
        ...
        assertEquals(LocalServiceInstanceState.UNHEALTHY, response.getState());
    }
    ...
    void testUsualFlowRecovery(final WireMockRuntimeInfo wm) {
        ...
        val spec = testLocalServiceInstanceSpec("hello-world", 1);
        val ctx = new InstanceActionContext<>(ExecutorTestingUtils.EXECUTOR_ID, spec, null, false);
        val action = new LocalServiceInstanceHealthcheckAction();
