...
/**
 * Tests {@link LocalServiceInstanceReadinessCheckAction}
 */
@WireMockTest
class LocalServiceInstanceReadinessCheckActionTest {
    @Test
    void testUsualFlow(final WireMockRuntimeInfo wm) {
        ...
        val action = new LocalServiceInstanceReadinessCheckAction();
        ...
        assertEquals(LocalServiceInstanceState.READY, response.getState());
    }
    ...
    void testFail(final WireMockRuntimeInfo wm) {
        ...
        val response = action.execute(ctx,
                                      StateData.create(LocalServiceInstanceState.HEALTHY,
                                                       ExecutorTestingUtils.createExecutorLocaLServiceInstanceInfo(spec, wm)));
        assertEquals(LocalServiceInstanceState.READINESS_CHECK_FAILED, response.getState());
    }
