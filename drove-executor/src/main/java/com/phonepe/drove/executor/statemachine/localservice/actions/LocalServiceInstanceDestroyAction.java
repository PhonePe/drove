...
public class LocalServiceInstanceDestroyAction
    ...
    public LocalServiceInstanceDestroyAction() {
        //Nothing to do here
    }
    ...
    @Override
    protected StateData<LocalServiceInstanceState, ExecutorLocalServiceInstanceInfo> preRemoveAction(
        ...
        return StateData.from(currentState, LocalServiceInstanceState.DEPROVISIONING);
    }
}
