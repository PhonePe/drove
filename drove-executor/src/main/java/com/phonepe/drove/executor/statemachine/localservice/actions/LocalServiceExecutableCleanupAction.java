 ...
 */
@Slf4j
public class LocalServiceExecutableCleanupAction extends CommonExecutableCleanupAction<ExecutorLocalServiceInstanceInfo,
        LocalServiceInstanceState, LocalServiceInstanceSpec> {

    @Inject
    public LocalServiceExecutableCleanupAction(ExecutorOptions options) {
       super(options);
    }
