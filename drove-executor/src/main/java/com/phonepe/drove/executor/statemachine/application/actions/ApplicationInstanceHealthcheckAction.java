 ...
 */
@Slf4j
public class ApplicationInstanceHealthcheckAction extends CommonInstanceHealthcheckAction<ExecutorInstanceInfo, InstanceState,
ApplicationInstanceSpec> {
    ...
    @Override
    protected InstanceState interruptedState() {
