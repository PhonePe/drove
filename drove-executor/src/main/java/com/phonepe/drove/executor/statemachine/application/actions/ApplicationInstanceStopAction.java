...
public class ApplicationInstanceStopAction
        extends CommonInstanceStopAction<ExecutorInstanceInfo, InstanceState, ApplicationInstanceSpec> {
    ...
    @Override
    protected PreShutdownSpec preShutdownSpec(ApplicationInstanceSpec spec) {
