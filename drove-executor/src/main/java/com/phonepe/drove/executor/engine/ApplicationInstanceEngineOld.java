 ...
 */
@Slf4j
public class ApplicationInstanceEngineOld implements Closeable {
    private final ExecutorIdManager executorIdManager;
    private final ExecutorService service;
    private final InstanceActionFactory<ExecutorInstanceInfo, InstanceState, ApplicationInstanceSpec> actionFactory;
    ...
    public ApplicationInstanceEngineOld(
...
/*    public MessageResponse handleMessage(final ExecutorMessage message) {
    ...
    public boolean startInstance(final ApplicationInstanceSpec spec) {
    ...
    public boolean registerInstance(
            ...
            final ApplicationInstanceSpec spec,
        ...
        try {
            ...
            val stateMachine = new ApplicationInstanceStateMachine(executorIdManager.executorId().orElse(null),
                                                                   spec,
                                                                   currentState,
                                                                   actionFactory,
                                                                   client);
    ...
    private static class SMInfo {
        ApplicationInstanceStateMachine stateMachine;
        Future<InstanceState> stateMachineFuture;
    }


    private boolean lockRequiredResources(ApplicationInstanceSpec spec) {
