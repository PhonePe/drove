...
import com.phonepe.drove.executor.resourcemgmt.metadata.config.ConfiguredMetadataProviderConfig;
...
@Slf4j
public class ConfiguredMetadataProvider implements MetadataProvider {
    ...
    @MetadataProviderNamed(MetadataProviderType.CONFIGURED)
