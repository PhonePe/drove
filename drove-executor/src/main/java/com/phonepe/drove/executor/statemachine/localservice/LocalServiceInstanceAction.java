 ...
 */
@Slf4j
public abstract class LocalServiceInstanceAction extends ExecutorActionBase<ExecutorLocalServiceInstanceInfo, LocalServiceInstanceState, LocalServiceInstanceSpec> {
