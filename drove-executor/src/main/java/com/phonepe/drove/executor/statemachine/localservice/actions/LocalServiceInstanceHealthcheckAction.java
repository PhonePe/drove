...
import com.phonepe.drove.executor.statemachine.common.actions.CommonInstanceHealthcheckAction;
 ...
 */
@Slf4j
public class LocalServiceInstanceHealthcheckAction extends CommonInstanceHealthcheckAction<ExecutorLocalServiceInstanceInfo, LocalServiceInstanceState, LocalServiceInstanceSpec> {
    ...
    @Override
    protected LocalServiceInstanceState interruptedState() {
        return LocalServiceInstanceState.STOPPING;
    }

    @Override
    protected LocalServiceInstanceState defaultErrorState() {
        return LocalServiceInstanceState.UNHEALTHY;
    }
