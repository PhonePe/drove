...
public enum DroveUserRole {
    ...
    EXTERNAL_ROOT(DROVE_EXTERNAL_ROOT_ROLE),
    EXTERNAL_READ_WRITE(DROVE_EXTERNAL_READ_WRITE_ROLE),
    DROVE_EXTERNAL_MAINTENANCE(DROVE_EXTERNAL_MAINTENANCE_ROLE),
    ...
    public static final class Values {
        ...
        public static final String DROVE_EXTERNAL_ROOT_ROLE = "DROVE_EXTERNAL_ROOT";
        public static final String DROVE_EXTERNAL_READ_WRITE_ROLE = "DROVE_EXTERNAL_READ_WRITE";
        public static final String DROVE_EXTERNAL_MAINTENANCE_ROLE = "DROVE_EXTERNAL_MAINTENANCE";
