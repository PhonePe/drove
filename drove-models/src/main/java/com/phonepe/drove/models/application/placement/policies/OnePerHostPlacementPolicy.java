...
/**
 * Placement policy that ensures only one instance per host
 */
@Value
...
@Jacksonized
@Builder
@Schema(description = "Placement policy that ensures only one container instance of an application runs per executor host")
