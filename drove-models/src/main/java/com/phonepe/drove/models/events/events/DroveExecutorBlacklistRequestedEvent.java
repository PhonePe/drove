...
public class DroveExecutorBlacklistRequestedEvent extends DroveExecutorEvent {
    public DroveExecutorBlacklistRequestedEvent(@JsonProperty("metadata") Map<ExecutorEventDataTag, Object> metadata) {
        super(DroveEventType.EXECUTOR_BLACKLIST_REQUESTED, metadata);
    }
